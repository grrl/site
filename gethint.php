...
if ($cards[0] == "0" && $cards[1] == "9" && $cards[2] == "10" && $cards[3] == "11" && $cards[4] == "12" ||
 ...
 else if ($cards[0] == "0" && $cards[1] == "1" && $cards[2] == "2" && $cards[3] == "3" && $cards[4] == "4" ||
...
$cards[1] == "3" && $cards[2] == "16" && $cards[3] == "29" && $cards[4] == "42") //first card random) //2's 3's or 4's
{
  ...
  $win == "4 2s, 3s or 4s";
...
else if ((($card[0] == "10" || $card[0] == "23" || $card[0] == "36" || $card[0] == "49") && //jacks
         ($card[1] == "10" || $card[1] == "23" || $card[1] == "36" || $card[1] == "49")) ||
         
         (($card[0] == "10" || $card[0] == "23" || $card[0] == "36" || $card[0] == "49") && 
         ($card[2] == "10" || $card[2] == "23" || $card[2] == "36" || $card[2] == "49")) ||
         
         (($card[0] == "10" || $card[0] == "23" || $card[0] == "36" || $card[0] == "49") && 
         ($card[3] == "10" || $card[3] == "23" || $card[3] == "36" || $card[3] == "49")) ||
         
         (($card[0] == "10" || $card[0] == "23" || $card[0] == "36" || $card[0] == "49") && 
         ($card[4] == "10" || $card[4] == "23" || $card[4] == "36" || $card[4] == "49")) ||
         ...
         (($card[0] == "11" || $card[0] == "24" || $card[0] == "37" || $card[0] == "50") && //queens
         ($card[1] == "11" || $card[1] == "24" || $card[1] == "37" || $card[1] == "50")) ||
         
         (($card[0] == "11" || $card[0] == "24" || $card[0] == "37" || $card[0] == "50") && 
         ($card[2] == "11" || $card[2] == "24" || $card[2] == "37" || $card[2] == "50")) ||
         
         (($card[0] == "11" || $card[0] == "24" || $card[0] == "37" || $card[0] == "50") && 
         ($card[3] == "11" || $card[3] == "24" || $card[3] == "37" || $card[3] == "50")) ||
         
         (($card[0] == "11" || $card[0] == "24" || $card[0] == "37" || $card[0] == "50") && 
         ($card[4] == "11" || $card[4] == "24" || $card[4] == "37" || $card[4] == "50")) ||
         ...
         (($card[0] == "12" || $card[0] == "25" || $card[0] == "38" || $card[0] == "51") && //KINGS
         ($card[1] == "12" || $card[1] == "25" || $card[1] == "38" || $card[1] == "51")) ||
         
         (($card[0] == "12" || $card[0] == "25" || $card[0] == "38" || $card[0] == "51") && 
         ($card[2] == "12" || $card[2] == "25" || $card[2] == "38" || $card[2] == "51")) ||
         
         (($card[0] == "12" || $card[0] == "25" || $card[0] == "38" || $card[0] == "51") && 
         ($card[3] == "12" || $card[3] == "25" || $card[3] == "38" || $card[3] == "51")) ||
         
         (($card[0] == "12" || $card[0] == "25" || $card[0] == "38" || $card[0] == "51") && 
         ($card[4] == "12" || $card[4] == "25" || $card[4] == "38" || $card[4] == "51")) ||
         ...
         (($card[0] == "0" || $card[0] == "13" || $card[0] == "26" || $card[0] == "39") && //ACES
         ($card[1] == "0" || $card[1] == "13" || $card[1] == "26" || $card[1] == "39")) ||
         
         (($card[0] == "0" || $card[0] == "13" || $card[0] == "26" || $card[0] == "39") && 
         ($card[2] == "0" || $card[2] == "13" || $card[2] == "26" || $card[2] == "39")) ||
         
         (($card[0] == "0" || $card[0] == "13" || $card[0] == "26" || $card[0] == "39") && 
         ($card[3] == "0" || $card[3] == "13" || $card[3] == "26" || $card[3] == "39")) ||
         
         (($card[0] == "0" || $card[0] == "13" || $card[0] == "26" || $card[0] == "39") && 
         ($card[4] == "0" || $card[4] == "13" || $card[4] == "26" || $card[4] == "39")) ||
         ...
         (($card[2] == "0" || $card[2] == "13" || $card[2] == "26" || $card[2] == "39") && 
         ($card[4] == "0" || $card[4] == "13" || $card[4] == "26" || $card[4] == "39")))//jacks or better
{
      $win = "JACKS OR BETTER";
}
*/
